...
readonly _KS_ssh=https://opendev.org/openstack/training-labs/raw/branch/master/labs/stack/lib/stack/netboot/ks-ssh-v2.cfg
readonly _KS_vbadd=https://opendev.org/openstack/training-labs/raw/branch/master/labs/stack/lib/stack/netboot/ks-vbadd.cfg
readonly _KS_all=https://opendev.org/openstack/training-labs/raw/branch/master/labs/stack/lib/stack/netboot/ks-all-v2.cfg
