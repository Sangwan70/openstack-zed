...
readonly _PS_ssh=https://opendev.org/openstack/training-labs/raw/branch/master/labs/stack/lib/stack/netboot/preseed-ssh-v6.cfg
readonly _PS_vbadd=https://opendev.org/openstack/training-labs/raw/branch/master/labs/stack/lib/stack/netboot/preseed-vbadd-v6.cfg
readonly _PS_all=https://opendev.org/openstack/training-labs/raw/branch/master/labs/stack/lib/stack/netboot/preseed-all-v6.cfg
