...
sudo dnf install -y openstack-heat-common openstack-heat-api openstack-heat-api-cfn openstack-heat-engine python3-pip
...
sudo cp /usr/local/lib/python3.9/site-packages/heat_dashboard/enabled/_[1-9]*.py \
